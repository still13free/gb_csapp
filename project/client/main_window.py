...
from project.client.main_window_conv import Ui_MainClientWindow
from project.client.add_contact import AddContactDialog
from project.client.del_contact import DelContactDialog
