...
from project.server.stat_window import StatWindow
from project.server.config_window import ConfigWindow
from project.server.add_user import RegisterUser
from project.server.remove_user import DelUserDialog
